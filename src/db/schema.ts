...
export const screening_form = mysqlTable('screening_form', {
  ...
  social_2: boolean('social_2'),
  social_3: boolean('social_3'),
  elderly_1_1: boolean('elderly_1_1'),
  elderly_1_2: boolean('elderly_1_2'),
  elderly_2_1: boolean('elderly_2_1'),
  elderly_2_2: boolean('elderly_2_2'),
  elderly_3: boolean('elderly_3'),
  elderly_4: boolean('elderly_4'),
  elderly_5_1: boolean('elderly_5_1'),
  elderly_5_2: boolean('elderly_5_2'),
  elderly_6: boolean('elderly_6'),
  elderly_7: boolean('elderly_7'),
  ...
  clock_draw: int('clock_draw'),
  sum_mini_cog: int('sum_mini_cog'),
  created_at: timestamp('created_at', { mode: 'date' }).notNull(),
  updated_at: timestamp('updated_at', { mode: 'date' }).notNull(),
});
