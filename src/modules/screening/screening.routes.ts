...
export const screeningRoute = new Elysia({ prefix: '/screening' })
  ...
  .put('forms/:form_id', screeningController.updateFormData.handler, screeningController.updateFormData.schema)
  .get('/', screeningController.getScreeningList.handler, screeningController.getScreeningList.schema)
  .get(
    '/:visit_id',
    screeningController.getScreeningByVisitID.handler,
    screeningController.getScreeningByVisitID.schema
  )
  .put('/visit/:visit_id', screeningController.updateVisitDate.handler, screeningController.updateVisitDate.schema);
