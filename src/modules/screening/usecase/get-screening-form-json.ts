...
export const getScreeningFormJson = (form: ElderlySectionDTO): MockupData => {
  ...
  } else if (form.elderly_1_1 === false) {
  ...
  } else if (form.elderly_1_2 === false) {
  ...
  } else if (form.elderly_2_1 === false) {
  ...
  } else if (form.elderly_2_2 === false) {
  ...
  } else if (form.elderly_5_1 === false) {
  ...
  } else if (form.elderly_5_2 === false) {
  ...
  } else if (form.elderly_8_1 === false) {
  ...
  } else if (form.elderly_8_2 === false) {
